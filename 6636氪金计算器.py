...
def hans1():
    ...
    button19 = Button(root, text='sin-1', bg=button_bg, padx=10, pady=3,
                      command=lambda : asin_an(entry), activebackground=button_active_bg)
    ...
    button21 = Button(root, text='cos-1', bg=button_bg, padx=10, pady=3,
                      command=lambda : acos_an(entry), activebackground=button_active_bg)
    ...
    button23 = Button(root, text='tan-1', bg=button_bg, padx=10, pady=3,
                      command=lambda : atan_an(entry), activebackground=button_active_bg)
    ...
    button24 = Button(root, text='对数底数', bg=button_bg, padx=10, pady=3,
                      command=lambda : log(entry), activebackground=button_active_bg)
    button24.grid(row=4, column=5, pady=5)
    
    button25 = Button(root, text='对数运算', bg=button_bg, padx=10, pady=3,
                      command=lambda : log1(entry), activebackground=button_active_bg)
    button25.grid(row=5, column=5, pady=5)
...
def hans2():
    ...
    def hans23():
        ...
        v1 = StringVar()
        e4 = Entry(root23, width=20, textvariable=v1, state='readonly').grid(row=4, column=1)
...
def hans3():
    ...
    v1 = StringVar()
    e2 = Entry(root3, width=15, textvariable=v1, state='readonly').grid(row=4, column=1)
...
def hans4():
    ...
    def hans42():
        ...
        Button(root42, text='求现值', width=10, command = Present_Value).grid(row=5, column=0, sticky=W, padx=10, pady=5)
    ...
    def hans43():
        ...
        Label(root43, text = 'pv现在资金总额').grid(row = 3,column = 0)
    ...
    def hans467():
        ...
        Label(root467, text = 'rate贴现率(小数)').grid(row = 1, column = 0)
...
def hans5():
    ...
    def hans51():
        ...
        def Integral_def():    #定积分，up,down都是数字
            ...
            temp = sym.integrate(e1.get(),(x, int(e3.get()),int(e4.get())))
            a = round(temp,4)
            v1.set(a)
    ...
    def hans54():
        ...
        Label(root54, text = '变量值').grid(row = 3, column = 0)
...
def hans61():
    ...
    def hans7():
        ...
        Label(root7, text = 'UP率(%)').grid(row = 1, column = 0)
    ...
    def hans8():
        ...
        Label(root8, text = 'UP率(%)').grid(row = 1, column = 0)
        Label(root8, text = 'SSR概率(%)').grid(row = 2, column = 0)
        Label(root8, text = 'SR概率(%)').grid(row = 3, column = 0)
        Label(root8, text = 'R概率(%)').grid(row = 4, column = 0)
